...
* **Sheets that travel.** Stored in the browser rather than on the server, shared through the URL fragment, exported as Markdown that can be opened again, ten worked examples in four languages, and a first sheet written natively in each of the five.
